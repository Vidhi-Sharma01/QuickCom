...
export default function Accordian({data,scid}) {
   ...
   function handleChanges(event, newValue) {
    ...
    const showAllSubCategory=()=>{
      return data.map((item)=>{
        ...
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header"style={{ display: 'flex',alignItems: 'center',flexGrow: 1,marginBottom:-10}} >
          <Typography style={{
           fontWeight: 700,
           fontSize: 14.5,
           letterSpacing: -0.07,
      ...
      <Divider style={{width:'90%',marginTop:'2%'}}/>
      </div>)
