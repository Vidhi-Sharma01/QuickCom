      ...
      const CartDetails=()=>{
        ...
        <div style={{display:'flex',alignItems:'center'}}>
           ...
           <div style={{display:'flex',flexDirection:'column',marginTop:'3%',marginLeft:matches?-200:-30}}>
                ...
                <div>
                <div style={{width:100,display:'flex',alignItems:'center',borderRadius:2,background:'#e5f7ee',color:'#03753c',fontSize:12,fontWeight:750,marginLeft:1,marginTop:4}}>You Save &#8377;{op} </div>
                </div></>:<>
                <div style={{display:'flex',alignItems:'center',fontFamily:'JioType, helvetica, arial, sans-serif',fontWeight:700,fontSize:16,letterSpacing:-0.08,lineHeight: 1.5,color:'#141414',marginTop:2}}>
                    &#8377;{item.price*item.qty} 
                </div></>}
    ...
    return(
      ...
      {userData?.length>0?<div>{showAddress()}</div>:<div></div>}  
        <div>
         ...
         <div style={{marginRight:'5%',fontFamily:'JioType, helvetica, arial, sans-serif',fontWeight:900,fontSize:'1rem',letterSpacing:-0.08,lineHeight: 1.25,color:'#141414',marginTop:-40,marginLeft:matches?'85%':'80%'}}> &#8377; {totalamount}</div>  
           {CartDetails()}
        </div>
        </div>
